...
- **Cross-organ coupling:** e.g. cardiovascular perfusion → kidney (24–48h), sepsis burden
  ...
  kidney**.
- **Individualization:** online hidden-state estimates now validate in three places:
  ...
  anion gap, and creatinine. Each improves downstream observable prediction beyond a
  strong baseline and a capacity-matched placebo.
